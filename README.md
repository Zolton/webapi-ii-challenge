...
X `findCommentsById()`: accepts an `id` and returns the comment associated with that id.
...
XX POST   | /api/posts/:id/comments | Creates a comment for the post with the specified id using information sent inside of the `request body`.                                                                   |
...
XX  GET    | /api/posts/:id/comments | Returns an array of all the comment objects associated with the post with the specified id.                                                                                 |
...
xIf the information about the _comment_ is valid:
